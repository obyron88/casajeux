Template.searchnoir.onCreated(function() {
    this.sortNoir = new ReactiveVar(1);
});

Template.searchnoir.events({
...
Template.searchnoir.helpers({
    // _.uniq évite les doublons
    type: function (){ return _.uniq(Noir.find({}, {
    ...
    édition: function (){ return _.uniq(Noir.find({}, {
    ...
    rareté: function (){ return _.uniq(Noir.find({}, {
    ...
    prix: function (){ return _.uniq(Noir.find({}, {
    ...
    mana: function (){ return _.uniq(Noir.find({}, {
    ...
    foil: function (){ return _.uniq(Noir.find({}, {
    ...
    nom: function (){ return _.uniq(Noir.find({}, {
...
// return les champs valides sélectionnés par selector
        return Noir.find(selector, { sort: { price: sortNoir }})
    },
