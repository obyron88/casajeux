Template.searchbleu.onCreated(function() {
    this.sortBleu = new ReactiveVar(1);
});

Template.searchbleu.events({
...
Template.searchbleu.helpers({
    // _.uniq évite les doublons
    type: function (){ return _.uniq(Bleu.find({}, {
    ...
    édition: function (){ return _.uniq(Bleu.find({}, {
    ...
    rareté: function (){ return _.uniq(Bleu.find({}, {
    ...
    prix: function (){ return _.uniq(Bleu.find({}, {
    ...
    mana: function (){ return _.uniq(Bleu.find({}, {
    ...
    foil: function (){ return _.uniq(Bleu.find({}, {
    ...
    nom: function (){ return _.uniq(Bleu.find({}, {
...
// return les champs valides sélectionnés par selector
        return Bleu.find(selector, { sort: { price: sortBleu }})
    },
