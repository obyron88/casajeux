Template.searchrouge.onCreated(function() {
    this.sortRouge = new ReactiveVar(1);
});

Template.searchrouge.events({
...
Template.searchrouge.helpers({
    // _.uniq évite les doublons
    type: function (){ return _.uniq(Rouge.find({}, {
    ...
    édition: function (){ return _.uniq(Rouge.find({}, {
    ...
    rareté: function (){ return _.uniq(Rouge.find({}, {
    ...
    prix: function (){ return _.uniq(Rouge.find({}, {
    ...
    mana: function (){ return _.uniq(Rouge.find({}, {
    ...
    foil: function (){ return _.uniq(Rouge.find({}, {
    ...
    nom: function (){ return _.uniq(Rouge.find({}, {
...
// return les champs valides sélectionnés par selector
        return Rouge.find(selector, { sort: { price: sortRouge }})
    },
