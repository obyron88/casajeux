Template.searchincolore.onCreated(function() {
    this.sortIncolore = new ReactiveVar(1);
});

Template.searchincolore.events({
...
Template.searchincolore.helpers({
    // _.uniq evite les doublons
    type: function (){ return _.uniq(Incolore.find({}, {
    ...
    edition: function (){ return _.uniq(Incolore.find({}, {
    ...
    rarete: function (){ return _.uniq(Incolore.find({}, {
    ...
    prix: function (){ return _.uniq(Incolore.find({}, {
    ...
    mana: function (){ return _.uniq(Incolore.find({}, {
    ...
    foil: function (){ return _.uniq(Incolore.find({}, {
    ...
    nom: function (){ return _.uniq(Incolore.find({}, {
...
// return les champs valides selectionnes par selector
        return Incolore.find(selector, { sort: { price: sortIncolore }})
    },
